...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            let book_date = $('#book_date .form-control');
            $('#form-edit-add').validate({
                ...
                messages: {
                    ...
                    book_price: {
                        required: "ثمن الكتاب مطلوب",
                        number: "يجب ان يكون ثمن الكتاب رقماً"
                    },
                    book_release_date: {
                        required: "تاريخ اصدار الكتاب مطلوب",
                        date: "تاريخ غير صالح"
                    },
                    "book_url[]": {
                        required: "الكتاب مطلوب",
                        accept: "الملف غير صالح، يجب ان يكون الملف من نوع pdf"
                    },
                }
            });

            book_date.attr('readonly', 'readonly');
